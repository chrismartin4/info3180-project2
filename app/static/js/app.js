                ...
                <div class ="card" style="width:18rem">
                   ...
                   <div class = "card-body">
                        <div class = "top-card">
                            ...
                            <p> <img src='/static/pricetag.jpg'>$ {{car.price}}  </p>
                        </div>
                        <p>  {{car.model}}  </p>
                    </div>
...
const CarInfo = {
    ...
    <div class="allcarinfo">
    <div class="yearmakeinfo">
        <h2> {{year}} {{make}}</h2> 
    </div>
    <div class="modelinfo">
        <p> {{model}} </p>  
    </div>
    <div class="descriptiontype">
        <p> {{description}} </p> <br>
    </div>
    <div class="colourbodytype" style="overflow: hidden;">
        <p style="float: left;"> Color: {{colour}} </p> 
    
        <p style="float: right;"> Body Type: {{car_type}} </p> <br>
    </div>
    <div class="pricetransmissiontype" style="overflow: hidden;">
        <p style="float: left;"> Price: $ {{price}} </p> 

        <p style="float: right;"> Transmission: {{transmission}} </p>
    </div>  

     
    <button class="btn btn-primary mb-2" style="float: left;" > Email Owner </button>

    <button v-if="faved" class="btn btn-white mb-2" style="float: right;">  <img id="favimg" src='/static/alreadyfav.jpg'> </button>
    <button v-else" @click="favouritecar(car_id)" class="btn btn-white mb-2" style="float: right;"> <img id="alrfavimg" src='/static/fav.png'> </button>
    </div>
    </div>
    ...
    <div class="myprofilepage">
        ...
        <p> Joined: {{user.date_joined}} </p> <br>
        </div>
        </div>
